...
| [0004](0004-tool-surface-token-offload.md) | Tool surface for host token offload | Superseded by 0008 |
...
| [0008](0008-tool-surface-v2-digest-and-evidence.md) | Tool surface v2: digest and evidence | Accepted |
